			...
			func(se *Engine, expectedTree *Tree) {
				...
				expectedTree.Item = map[ItemID]Item{
					item.ID(): {
						ID:             item.ID(),
						Name:           "myItem",
						BoundTo:        &ElementReference{OperationKindUnchanged, int(player.ID()), ElementKindPlayer, ReferencedDataModified, newPath(playerIdentifier, int(player.ID()))},
						OperationKind_: OperationKindUnchanged,
					},
				}
						...
						GuildMembers: []ElementReference{
							{
								...
								ElementPath:          newPath(playerIdentifier, int(player2.ID())),
							},
						},
						OperationKind_: OperationKindUpdate,
					},
						...
						GuildMembers: []ElementReference{
							{
								...
								ElementKind:          ElementKindPlayer,
								ReferencedDataStatus: ReferencedDataModified,
								ElementPath:          newPath(playerIdentifier, int(player1.ID())),
							},
						},
					},
					player3.ID(): {
						...
						GuildMembers: []ElementReference{
							{
								...
								ElementKind:          ElementKindPlayer,
								ReferencedDataStatus: ReferencedDataModified,
								ElementPath:          newPath(playerIdentifier, int(player.ID())),
							},
							{
								OperationKind:        OperationKindUpdate,
								ElementID:            int(player.ID()),
						...
						EquipmentSets: []ElementReference{
							{
								...
								ReferencedDataStatus: ReferencedDataModified,
								ElementPath:          newPath(equipmentSetIdentifier, int(equipmentSet.ID())),
							},
						},
						OperationKind_: OperationKindUnchanged,
					},
						...
						Equipment: []ElementReference{
							{
								...
								ReferencedDataStatus: ReferencedDataModified,
								ElementPath:          newPath(itemIdentifier, int(item.ID())),
							},
						},
						OperationKind_: OperationKindUnchanged,
					},
