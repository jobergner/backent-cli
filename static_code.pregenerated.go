// this code was generated by sourcing the examples within this repo

package main


const importedCode_server string = `package server
import (
	"nhooyr.io/websocket"
...
const importedCode_client string = `package client
import (
	"github.com/rs/zerolog/log"
	"{{path}}/examples/connect"
	"errors"
...
const importedCode_connect string = `package connect
import (
	"context"
	"{{path}}/examples/logging"
	"github.com/rs/zerolog/log"
...
const importedCode_logging string = `package logging
const (
	RoomName		= "roomName"
	ClientID		= "clientID"
...
const importedCode_message string = `package message
...
const importedCode_state string = `package state
import (
	"sort"
	"sync"
	"bytes"
